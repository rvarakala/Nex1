    ...
    <div className="min-h-screen bg-slate-100" data-testid="partner-portal-page">
      ...
      <main className="p-6 space-y-5 max-w-5xl mx-auto">
        ...
        {/* NAV-011 · Phase 2C · REVENUE ATTRIBUTION only.
            This section shows revenue GENERATED by patients referred
            by this partner. It is NOT a referral amount / commission /
            amount payable. The Est. commission tile above continues to
            reflect the discretionary payout — Phase 2C did not change
            how that number is computed. */}
        <section
          className="border border-slate-200 rounded-lg p-4 bg-white"
          data-testid="partner-revenue-attribution-section"
        >
          <div className="flex items-baseline justify-between mb-2">
            <h2
              className="text-sm font-bold uppercase tracking-wider text-slate-700"
              data-testid="partner-revenue-attribution-heading"
            >
              Revenue Attribution
            </h2>
            <p className="text-[11px] text-slate-500 max-w-md text-right">
              Revenue generated by referred patients — not a referral
              amount. The referral amount you receive remains at your
              clinic's discretion.
            </p>
          </div>
