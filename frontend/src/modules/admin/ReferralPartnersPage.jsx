        ...
        <div className="p-5 space-y-4 overflow-auto">
          {stats && (
            <>
              ...
              {/* NAV-011 · Phase 2C · REVENUE ATTRIBUTION only.
                  Analytics-only. Existing Revenue / Est. Commission
                  tiles above remain the discretionary-payout view;
                  this section is what the referred patients GENERATED,
                  not what the clinic pays the partner. */}
              <section
                className="border border-slate-200 rounded-lg p-3"
                data-testid="partner-stats-revenue-attribution-section"
              >
                <div className="flex items-baseline justify-between mb-2">
                  <h4
                    className="text-[11px] font-bold uppercase tracking-wider text-slate-700"
                    data-testid="partner-stats-revenue-attribution-heading"
                  >
                    Revenue Attribution
                  </h4>
                  <span className="text-[10px] text-slate-500">
                    Revenue generated by referred patients — not a referral amount.
                  </span>
                </div>
